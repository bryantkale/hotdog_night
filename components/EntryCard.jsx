...
export function EntryCard({ entry, onDelete }) {
    return (
        <div className="hdl-entry-card">
            <div className="hdl-entry-rating-badge" aria-label={`${entry.rating || 0} out of 5 stars`}>
                <span className="hdl-entry-rating-value">{entry.rating || 0}</span>
                <span className="hdl-entry-rating-max">/5</span>
            </div>
